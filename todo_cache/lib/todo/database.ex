defmodule Todo.Database do
    ...
    def init(db_folder) do
      ...
      worker_map = Map.new()
      |> Map.put(0, get_pid(Todo.DatabaseWorker.start(db_folder)))
      |> Map.put(1, get_pid(Todo.DatabaseWorker.start(db_folder)))
      |> Map.put(2, get_pid(Todo.DatabaseWorker.start(db_folder)))
      |> IO.inspect
